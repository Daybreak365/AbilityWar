package Marlang.AbilityWar.Game;
	...
	private void parseCommand(CommandSender sender, String label, String[] split) {
		if(split.length == 0) {
			Messager.sendStringList(sender, Messager.getStringList(
					...
					ChatColor.translateAlternateColorCodes('&', "&b°³¹ßÀÚ &7: &f_Marlang ¸»¶û"),
					ChatColor.translateAlternateColorCodes('&', "&9µğ½ºÄÚµå &7: &f¸»¶û&7#5908"),
