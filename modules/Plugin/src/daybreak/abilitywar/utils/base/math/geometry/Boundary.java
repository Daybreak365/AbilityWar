...
public class Boundary {
	...
	public static class EntityBoundingBox implements BoundingBox {

		public static EntityBoundingBox of(Entity entity) {
			BoundaryData data = BoundaryData.of(Preconditions.checkNotNull(entity).getType());
