...
public class ShotPut extends Synergy implements ActiveHandler {
	...
	public static final SettingObject<Integer> DURATION_CONFIG = synergySettings.new SettingObject<Integer>(ShotPut.class, "duration", 6,
			"# 지속 시간") {
	...
	private final Cooldown cooldownTimer = new Cooldown(COOLDOWN_CONFIG.getValue(), CooldownDecrease._75);
