...
public class SpecialThanks {
	...
	private static final Category DEVELOPER = new Category("§3개발자", new CustomSkullBuilder("bd9f18c9d85f92f72f864d67c1367e9a45dc10f371549c46a4d4dd9e4f13ff4").build())
			.addSpecialThanks(
					new SpecialThank("f6cef0829b7e48c1a973532389b6e3e1",
							"§7레인스타님",
			...
			.addSpecialThanks(
					new SpecialThank("ecb53e2ffdf34089ae3486cff3fc5f34",
							"§7코크스님",
	...
	private static final Category TESTER = new Category("§e테스터", new CustomSkullBuilder("b33598437e313329eb141a13e92d9b0349aabe5c6482a5dde7b73753634aba").build())
			.addSpecialThanks(
					new SpecialThank("2dcb3299e24049adb8bb554d862bd7be",
							"§7루르님",
			...
			.addSpecialThanks(
					new SpecialThank("101ceb32a2bc4dbd9d32291c86b66eca",
							"§7퀘네님",
			...
			.addSpecialThanks(
					new SpecialThank("2b4af44c86434a2fa3b07a34f4406636",
							"§7망고님",
			...
			.addSpecialThanks(
					new SpecialThank("588d15d1fdb54e2db039a47d994d8390",
							"§7엔샤님",
			...
			.addSpecialThanks(
					new SpecialThank("d520b367afc3425b978e4f0a2682a379",
							"§7쿤이님",
			...
			.addSpecialThanks(
					new SpecialThank("59ca33cc6a974045aae405f171b1206a",
							"§7시그님",
	...
	private static final Category STREAMER = new Category("§a스트리머", new CustomSkullBuilder("148a8c55891dec76764449f57ba677be3ee88a06921ca93b6cc7c9611a7af").build())
			.addSpecialThanks(
					new SpecialThank("507fc49666fb43489200251f48bf4719",
							"§7윤하루님",
			...
			.addSpecialThanks(
					new SpecialThank("4cf9e977d664427694be4358b1794ea3",
							"§7악어님",
			...
			.addSpecialThanks(
					new SpecialThank("5ad79e2f720744bfbdcbf0dcc82691e2",
							"§7메이님",
			...
			.addSpecialThanks(
					new SpecialThank("25cc5950b380499dbe681817b7d40a37",
							"§7리더님",
			...
			.addSpecialThanks(
					new SpecialThank("e21490bf19e64fcc8d3c763ed3bff789",
							"§7김종겜님",
			...
			.addSpecialThanks(
					new SpecialThank("3298b2aafce340189654b2a76ce8c471",
							"§7울산광부님",
							"세계 최초 광질을 잘하는 스트리머!",
	...
	public static class SpecialThank {
		...
		public SpecialThank(String uuid, String... description) {
