...
@AbilityManifest(name = "광대", rank = Rank.A, species = Species.HUMAN, explain = {
        ...
        "§7패시브 §8- §5암습§f: 플레이어를 후방에서 타격하면 1.5초간 §b§n공포§f에 빠뜨리고 추가",
        " 대미지를 줍니다. 유닛별 쿨타임§8(§7$[UNIT_COOLDOWN_CONFIG]초§8)§f이 적용됩니다.",
        "§7특수 효과 §8- §b은신§f: 갑옷 및 손에 들고 있는 아이템이 보이지 않으며, 몸이",
        " 투명해집니다."
}, summarize = {
        "§7철괴 우클릭§f으로 전방에 순간이동해 §b은신§f합니다.",
        "§7재사용 시§f 이동 전 위치로 복귀 후 주변 플레이어를 §9공포§f에 빠뜨립니다.",
        "적 후방을 §c타격하여§f 대상에게 §9공포§f 및 §c추가 피해§f를 입힙니다."
})
