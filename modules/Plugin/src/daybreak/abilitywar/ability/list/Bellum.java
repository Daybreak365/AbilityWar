...
@AbilityManifest(name = "벨리움", rank = Rank.S, species = Species.HUMAN, explain = {
        ...
        " 벽을 파괴하고 주변의 플레이어들을 §e§n기절§f시키며 피해를 줍니다.",
        "§7패시브 §8- §c일방적 구타 §6(§e기력 0.5 소모§6)§f: §e§n기절§f 상태의 적에게 피해를 줄 때 피해량이",
        " $[BEAT_DAMAGE_CONFIG]배가 됩니다."
}, summarize = {
        "§7철괴 우클릭§f 시 잠시간 §3타게팅 불가§f 상태가 되어 전방을 향해 §c돌진§f합니다.",
        "§c돌진§f 중 지형에 충돌 시 지형을 파괴하고 주변 플레이어를 §e§n기절§f시킵니다.",
        "§e§n기절§f한 적에게 주는 피해량이 증가합니다.",
        "위 스킬들은 일정량의 §e기력§f을 소모합니다."
})
