...
@AbilityManifest(name = "카니스", rank = Rank.L, species = Species.HUMAN, explain = {
		...
		"§7철괴 우클릭§f으로 §6말§f을 소환해 승마합니다.",
		"승마 중에는 §a랜스§f를 충전해 근접 공격을 §3방어력 관통 피해§f로 강화합니다.",
		"§7철괴 좌클릭§f으로 §6말§f의 §e기력§f을 소모해 §b이동 속도§f를 가속시키며, §a랜스§f 피해를 강화합니다.",
		"§6말§f에서 내려 §6말§f의 남은 체력을 짧은 시간 유지되는 §e흡수 체력§f으로 전환합니다.",
		"§3넉백§f 및 §3그랩§f 영향을 받지 않습니다."
})
