...
@AbilityManifest(name = "아레스", rank = Rank.A, species = Species.GOD, explain = {
        ...
        "§7철괴 우클릭§f 시 전방으로 §a도약§f합니다.",
        "§a도약§f 중 생명체들을 끌어오며 §c피해입히고§f 착지할 때 §b밀쳐냅니다§f."
})
@Tips(tip = {
...
public class Ares extends AbilityBase implements ActiveHandler {
    ...
    public static final SettingObject<Integer> DAMAGE_CONFIG = abilitySettings.new SettingObject<Integer>(Ares.class, "damage-percent", 80,
            "# 스킬 대미지 (단위: 백분율)",
