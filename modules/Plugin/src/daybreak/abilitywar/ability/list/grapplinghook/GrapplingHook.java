...
@AbilityManifest(name = "그래플링 훅", rank = Rank.L, species = Species.HUMAN, explain = {
        ...
        " 상태로 도약한 경우, 해당 적을 §e§n기절§f시키고 최대 체력 비례 피해를 입힙니다.",
        "§7패시브 §8- §3가벼운 착지§f: 낙하 피해를 입지 않습니다."
}, summarize = {
        "낙하 피해를 받지 않습니다.",
        "§7철괴 우클릭§f으로 §3후크§f를 발사해 적중 위치까지 이동합니다.",
        "이동 중 §8/§f 고정간 웅크리기로 도약해 돌진 거리 내 적들을 §c피해입히고§f §e§n기절§f시킵니다.",
        "이 효과는 §3후크§f를 적에게 직접 맞히면 §a자동 발동§f합니다."
})
