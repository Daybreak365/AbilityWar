...
public class Pumpkin extends AbilityBase implements ActiveHandler {
	...
	private void onInventoryClick(InventoryClickEvent e) {
		if (durationTimer.isRunning() && players.containsKey(e.getWhoClicked()) && e.getCurrentItem() != null && e.getCurrentItem().getType() == Material.PUMPKIN) {
			if (e.getCurrentItem().getItemMeta().getDisplayName().equals(ChatColor.GOLD + "호박")) {
				e.setCancelled(true);
			}
		}
	}
