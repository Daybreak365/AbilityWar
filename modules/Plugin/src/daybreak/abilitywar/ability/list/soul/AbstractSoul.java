...
@AbilityManifest(name = "소울", rank = Rank.S, species = Species.HUMAN, explain = {
        ...
        " §b§n공포§f에 빠뜨리고, 가장 가까운 적을 따라가는 유령 여섯을 소환합니다.",
        " 유령은 4초 뒤 사라지면서 주변에 각각 $[VINDICTIVE_DAMAGE]의 고정 피해를 입힙니다.",
        "§7더블 점프 §8- §b유령화 §8(§7두려움 1 소모§8)§f: 3초간 타게팅 불가능한 유령 상태로 변하여",
        " 앞으로 돌진합니다. 지속시간이 끝날 때, 주변 6칸 이내의 적들을 1.2초간 §b§n공포§f에",
        " 빠뜨립니다.",
        "§7패시브 §8- §b유령의 몸§f: 낙하 피해를 입지 않습니다."
}, summarize = {
        "§7검 우클릭§f으로 대상의 §8두려움§f을 흡수하여 §c도망§f치면 §c끌어§f오고 §b다가§f오면 §b밀쳐§f냅니다.",
        "§7철괴 우클릭§f 시 §8두려움§f을 4 소모해 주변 적 §b§n공포§f 및 적에게 §c자폭§f하는 §3유령§f을 소환합니다.",
        "§7더블 점프§f 시 §8두려움§f을 1 소모해 잠시간 §b관전 상태§f로 돌진 후 주변 적을 §b§n공포§f에 빠뜨립니다.",
        "낙하 피해를 받지 않습니다."
})
