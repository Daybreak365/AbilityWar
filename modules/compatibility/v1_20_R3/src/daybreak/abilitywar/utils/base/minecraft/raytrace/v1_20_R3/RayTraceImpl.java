package daybreak.abilitywar.utils.base.minecraft.raytrace.v1_20_R3;
...
public class RayTraceImpl implements IRayTrace {
	...
	public boolean hitsBlock(World world, double ax, double ay, double az, double bx, double by, double bz) {
		final MovingObjectPositionBlock rayTrace = ((IBlockAccess) ((CraftWorld) world).getHandle()).clip(new RayTrace(new Vec3D(ax, ay, az), new Vec3D(bx, by, bz), BlockCollisionOption.COLLIDER, FluidCollisionOption.NONE, VoxelShapeCollision.empty()));
