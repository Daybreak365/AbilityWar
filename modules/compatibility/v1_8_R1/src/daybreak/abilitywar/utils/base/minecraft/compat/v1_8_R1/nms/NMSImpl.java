package daybreak.abilitywar.utils.base.minecraft.compat.v1_8_R1.nms;
...
public class NMSImpl implements NMS {
	...
	public void setSpeed(LivingEntity entity, double speed) {
		((CraftLivingEntity) entity).getHandle().getAttributeInstance(GenericAttributes.d).setValue(speed);
	}
