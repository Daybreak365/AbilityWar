package daybreak.abilitywar.utils.base.minecraft.damage.v1_10_R1;
...
public class DamageImpl implements IDamages {
	...
	public boolean damageMagic(@NotNull Entity entity, @Nullable Player damager, boolean ignoreArmor, float damage) {
		final net.minecraft.server.v1_10_R1.Entity nmsEntity = ((CraftEntity) entity).getHandle();
		final net.minecraft.server.v1_10_R1.EntityPlayer nmsDamager = damager != null ? ((CraftPlayer) damager).getHandle() : null;
