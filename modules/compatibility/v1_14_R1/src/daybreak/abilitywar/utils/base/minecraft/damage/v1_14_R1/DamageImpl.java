...
public class DamageImpl implements IDamages {
	...
	public boolean damageExplosion(@NotNull Entity entity, @NotNull Entity source, float damage) {
		final net.minecraft.server.v1_14_R1.Entity nmsEntity = ((CraftEntity) entity).getHandle(), nmsSource = ((CraftEntity) source).getHandle();
		return nmsEntity.damageEntity(DamageSource.explosion(new Explosion(
				nmsEntity.world, nmsSource, nmsSource.locX, nmsSource.locY, nmsSource.locZ, 0f, false, Effect.NONE
		)), damage);
	}
	...
	public boolean damageMagic(@NotNull Entity entity, @Nullable Player damager, boolean ignoreArmor, float damage) {
		final net.minecraft.server.v1_14_R1.Entity nmsEntity = ((CraftEntity) entity).getHandle();
		final net.minecraft.server.v1_14_R1.EntityPlayer nmsDamager = damager != null ? ((CraftPlayer) damager).getHandle() : null;
