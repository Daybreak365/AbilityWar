...
import net.minecraft.server.v1_9_R2.EntityDamageSourceIndirect;
...
public class DamageImpl implements IDamages {
	...
	public boolean damageMagic(@NotNull Entity entity, @Nullable Player damager, boolean ignoreArmor, float damage) {
		final net.minecraft.server.v1_9_R2.Entity nmsEntity = ((CraftEntity) entity).getHandle();
		final net.minecraft.server.v1_9_R2.EntityPlayer nmsDamager = damager != null ? ((CraftPlayer) damager).getHandle() : null;
