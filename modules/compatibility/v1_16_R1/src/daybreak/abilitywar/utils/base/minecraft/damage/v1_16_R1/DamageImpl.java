package daybreak.abilitywar.utils.base.minecraft.damage.v1_16_R1;
...
import net.minecraft.server.v1_16_R1.ExplosionDamageCalculatorBlock;
...
public class DamageImpl implements IDamages {
	...
	public boolean damageExplosion(@NotNull Entity entity, @NotNull Entity source, float damage) {
		final net.minecraft.server.v1_16_R1.Entity nmsEntity = ((CraftEntity) entity).getHandle(), nmsSource = ((CraftEntity) source).getHandle();
		final Explosion explosion = new Explosion(
				nmsEntity.world, nmsSource, null, ExplosionDamageCalculatorBlock.INSTANCE,
	...
	public boolean damageMagic(@NotNull Entity entity, @Nullable Player damager, boolean ignoreArmor, float damage) {
		final net.minecraft.server.v1_16_R1.Entity nmsEntity = ((CraftEntity) entity).getHandle();
		final net.minecraft.server.v1_16_R1.EntityPlayer nmsDamager = damager != null ? ((CraftPlayer) damager).getHandle() : null;
