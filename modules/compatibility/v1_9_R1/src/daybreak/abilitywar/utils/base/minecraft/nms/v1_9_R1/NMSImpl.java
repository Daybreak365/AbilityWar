...
import net.minecraft.server.v1_9_R1.ItemCooldown;
...
public class NMSImpl implements INMS {
	...
	public void setArrowsInBody(Player player, int count) {
		...
		((CraftPlayer) player).getHandle().getDataWatcher().set(new DataWatcherObject<>(9, DataWatcherRegistry.b), count);
	}
	...
	public void setCooldown(Player player, Material material, int ticks) {
		((CraftPlayer) player).getHandle().da().a(CraftMagicNumbers.getItem(material), ticks);
	}

	@Override
	public boolean hasCooldown(Player player, Material material) {
		return ((CraftPlayer) player).getHandle().da().a(CraftMagicNumbers.getItem(material));
	}

	@Override
	public int getCooldown(Player player, Material material) {
		final ItemCooldown cooldownTracker = ((CraftPlayer) player).getHandle().da();
		final net.minecraft.server.v1_9_R1.Item item = CraftMagicNumbers.getItem(material);
	...
	public void resetWorldBorder(Player receiver) {
		...
		final net.minecraft.server.v1_9_R1.World world = nms.getWorld();
		if (world != null) {
